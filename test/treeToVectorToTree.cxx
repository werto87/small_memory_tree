...
TEST_CASE ("treeToVector")
{
  ...
  auto result = childrenByPath (smt, std::vector<std::tuple<uint8_t, Result> >{ { 253, Result::Undefined } }); // root was not created with a certain value and the default value is 253
