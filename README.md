...
## TODO TLDR overview when how much heap memory small memory tree uses compared to a vecPlusPointerToParentNode tree (stlplus::ntree). Max children count means the maximum amount of children 
